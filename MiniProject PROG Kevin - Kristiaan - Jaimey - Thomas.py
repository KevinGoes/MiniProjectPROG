...
if invoerOptie == '1':
    ...
    invoerNaam = input("Vul hier uw voornaam in: ")
    invoerANaam = input("Vul hier uw achternaam in: ")
    invoerAGebDatum = input("Vul hier uw geboortedatum in: ")
    invoerMerkFiets = input("Vul hier het merk van uw fiets in: ")
    registreren(invoerNaam, invoerANaam, invoerAGebDatum, invoerMerkFiets)
    print('Uw registratienummer = {}'.format(registreren(invoerNaam, invoerANaam, invoerAGebDatum, invoerMerkFiets)))
else:
    print('Geen optie')