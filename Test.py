...
def toonInformatiePersoonlijkOutput():
    if infoPersoonlijk(invoerStalling.get(), invoerWachtwoord.get()) == 'fout':
        tooInformatiePersoonlijkFoutFrame()
...
InformatieLabel = Label(master=InformatiePersoonlijkFrame, text=infoPersoonlijk(invoerStalling.get(), invoerWachtwoord.get()), background='yellow', foreground='blue', width=50, height=5, font=('Helvetica', 25, 'bold'))
InformatieLabel.pack(padx=20, pady=20)
